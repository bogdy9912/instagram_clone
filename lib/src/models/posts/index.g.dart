...
class _$PostsState extends PostsState {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc($jc($jc(0, info.hashCode), posts.hashCode),
                    comments.hashCode),
                userPosts.hashCode),
...
class PostsStateBuilder implements Builder<PostsState, PostsStateBuilder> {
  ...
  ListBuilder<Post> get savedPosts =>
      _$this._savedPosts ??= new ListBuilder<Post>();
  set savedPosts(ListBuilder<Post> savedPosts) =>
...
class _$Comment extends Comment {
  ...
  _$Comment._({this.id, this.text, this.userId, this.likes}) : super._() {
    if (id == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, id.hashCode), text.hashCode), userId.hashCode),
        likes.hashCode));
  }
...
class CommentBuilder implements Builder<Comment, CommentBuilder> {
  ...
  _$Comment build() {
    ...
    try {
      _$result = _$v ??
          new _$Comment._(
              id: id, text: text, userId: userId, likes: likes.build());
    } catch (_) {
      String _$failedField;
      try {
        _$failedField = 'likes';
