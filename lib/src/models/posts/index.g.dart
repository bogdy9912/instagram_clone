...
class _$PostsStateSerializer implements StructuredSerializer<PostsState> {
  ...
  Iterable<Object> serialize(Serializers serializers, PostsState object,
    ...
    final result = <Object>[
      'info',
      serializers.serialize(object.info, specifiedType: const FullType(PostsInfo)),
      'posts',
      serializers.serialize(object.posts,
          specifiedType: const FullType(BuiltMap, const [const FullType(String), const FullType(Post)])),
      'comments',
      serializers.serialize(object.comments, specifiedType: const FullType(BuiltList, const [const FullType(Comment)])),
      'userPosts',
      serializers.serialize(object.userPosts, specifiedType: const FullType(BuiltList, const [const FullType(Post)])),
      'taggedPosts',
      serializers.serialize(object.taggedPosts, specifiedType: const FullType(BuiltList, const [const FullType(Post)])),
      'savedPosts',
      serializers.serialize(object.savedPosts, specifiedType: const FullType(BuiltList, const [const FullType(Post)])),
    ];
  ...
  PostsState deserialize(Serializers serializers, Iterable<Object> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'info':
          result.info.replace(serializers.deserialize(value, specifiedType: const FullType(PostsInfo)) as PostsInfo);
          break;
        case 'posts':
...
class _$PostsInfoSerializer implements StructuredSerializer<PostsInfo> {
  ...
  Iterable<Object> serialize(Serializers serializers, PostsInfo object,
    ...
    if (object.lat != null) {
      result..add('lat')..add(serializers.serialize(object.lat, specifiedType: const FullType(double)));
    }
    if (object.lng != null) {
      result..add('lng')..add(serializers.serialize(object.lng, specifiedType: const FullType(double)));
    }
    return result;
  }
...
class _$PostSerializer implements StructuredSerializer<Post> {
  ...
  Iterable<Object> serialize(Serializers serializers, Post object, {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      ...
      serializers.serialize(object.tags, specifiedType: const FullType(BuiltList, const [const FullType(String)])),
      'likes',
      serializers.serialize(object.likes, specifiedType: const FullType(BuiltList, const [const FullType(String)])),
    ];
    if (object.description != null) {
      result..add('description')..add(serializers.serialize(object.description, specifiedType: const FullType(String)));
    }
...
class _$CommentSerializer implements StructuredSerializer<Comment> {
  ...
  @override
  Iterable<Object> serialize(Serializers serializers, Comment object, {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'id',
      serializers.serialize(object.id, specifiedType: const FullType(String)),
      'text',
...
class _$PostsState extends PostsState {
  ...
  @override
  final BuiltList<Post> savedPosts;

  factory _$PostsState([void Function(PostsStateBuilder) updates]) =>
      (new PostsStateBuilder()..update(updates)).build();

  _$PostsState._({this.info, this.posts, this.comments, this.userPosts, this.taggedPosts, this.savedPosts})
      : super._() {
    if (info == null) {
    ...
    if (savedPosts == null) {
      throw new BuiltValueNullFieldError('PostsState', 'savedPosts');
    }
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc($jc(0, info.hashCode), posts.hashCode), comments.hashCode), userPosts.hashCode),
...
class PostsStateBuilder implements Builder<PostsState, PostsStateBuilder> {
  ...
  MapBuilder<String, Post> get posts => _$this._posts ??= new MapBuilder<String, Post>();
  ...
  ListBuilder<Post> get userPosts => _$this._userPosts ??= new ListBuilder<Post>();

  set userPosts(ListBuilder<Post> userPosts) => _$this._userPosts = userPosts;

  ListBuilder<Post> _taggedPosts;

  ListBuilder<Post> get taggedPosts => _$this._taggedPosts ??= new ListBuilder<Post>();

  set taggedPosts(ListBuilder<Post> taggedPosts) => _$this._taggedPosts = taggedPosts;

  ListBuilder<Post> _savedPosts;

  ListBuilder<Post> get savedPosts => _$this._savedPosts ??= new ListBuilder<Post>();

  set savedPosts(ListBuilder<Post> savedPosts) => _$this._savedPosts = savedPosts;
  ...
  PostsStateBuilder get _$this {
    if (_$v != null) {
      ...
      _savedPosts = _$v.savedPosts?.toBuilder();
      _$v = null;
    }
    return this;
  }
...
class _$PostsInfo extends PostsInfo {
  ...
  factory _$PostsInfo([void Function(PostsInfoBuilder) updates]) => (new PostsInfoBuilder()..update(updates)).build();

  _$PostsInfo._({this.paths, this.tags, this.description, this.users, this.lat, this.lng}) : super._() {
    if (paths == null) {
  ...
  @override
  PostsInfo rebuild(void Function(PostsInfoBuilder) updates) => (toBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc($jc(0, paths.hashCode), tags.hashCode), description.hashCode), users.hashCode), lat.hashCode),
        lng.hashCode));
  }
  ...
  _$PostsInfo build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError('PostsInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$Post extends Post {
  ...
  _$Post._({this.id, this.uid, this.description, this.lat, this.lng, this.users, this.images, this.tags, this.likes})
      : super._() {
    if (id == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc(
                    $jc($jc($jc($jc($jc(0, id.hashCode), uid.hashCode), description.hashCode), lat.hashCode),
                        lng.hashCode),
                    users.hashCode),
                images.hashCode),
            tags.hashCode),
...
class _$Comment extends Comment {
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Comment && id == other.id && text == other.text && userId == other.userId;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Comment')..add('id', id)..add('text', text)..add('userId', userId)).toString();
  }
}
